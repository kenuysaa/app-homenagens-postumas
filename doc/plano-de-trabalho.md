...
|Classe|Detalhamento|
|------|------------|
|Aplicativo Móvel|Aplicativo mobile desenvolvido para Android, com funcionalidade de publicação de texto, imagens e vídeos.|
...
## 2.1 Objetivo
Desenvolver uma rede social de homenagens póstumas dedicada a preservar e compartilhar memórias de entes queridos falecidos, oferecendo um ambiente onde amigos e familiares possam se reunir virtualmente para prestar homenagens, compartilhar histórias, fotos, vídeos e recordar os momentos especiais vividos com a pessoa falecida.

## 2.2 Escopo geral
O aplicativo contará com publicações entre os usuários em uma página principal para compartilhar textos, fotos e vídeos em memória do falecido. O sistema terá uma linha do tempo, uma maneira de organizar e visualizar os momentos mais marcantes da vida da pessoa querida. Controle total sobre quem pode acessar e interagir com o conteúdo, assegurando um ambiente seguro e respeitoso.

### 2.2.1 Escopo Específico
- Cadastro de página do falecido com um perfil responsável. Esse perfil poderá aceitar solicitações de acesso a visualização ou publicação de outros usuários.
- Os usuários terão perfis individuais para homenagear entes queridos falecidos.
...
- Permitir que os usuários adicionem eventos, datas importantes e histórias relacionadas à pessoa querida.
- Integração de ferramentas de edição para personalização de homenagens.
- Implementação de um layout que permita fácil navegação entre as diferentes seções: Linha de Postagens, Mural Virtual e a Linha do Tempo.
- Desenvolver uma linha do tempo interativa que destaque os momentos mais significativos da vida do falecido.
...
- Feedback positivo dos usuários em relação a usabilidade do aplicativo mobile.
...
|----------------|------------|
|Gerente de Projeto|Guilherme Kenuy Saavedra Nunes|
